    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-zinc-600">
          Edit clinical department information, banner photos, and the Why/When/Benefit breakdown for all {departments.reduce((sum, d) => sum + d.subServices.length, 0)} treatments.
        </p>
      </div>
