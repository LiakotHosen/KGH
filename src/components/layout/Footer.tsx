...
export function Footer() {
  ...
  return (
    <footer className="bg-zinc-950 text-zinc-300 border-t border-zinc-800">
      ...
      <div className="border-b border-zinc-900 bg-zinc-900/50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-zinc-800 text-white rounded-xl border border-zinc-700">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-white text-xs font-semibold transition-all shadow-xs"
            >
            ...
            <Link
              href="/appointment"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white hover:bg-zinc-100 text-zinc-950 text-xs font-bold transition-all shadow-xs"
            >
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-2 pt-2 text-xs text-zinc-300">
              <div className="flex items-start gap-2.5">
                ...
                <span className="text-zinc-400">{t(CLINIC_SETTINGS.address)}</span>
              </div>
            ...
            <div className="space-y-3 text-xs text-zinc-400">
              {CLINIC_SETTINGS.workingHours.map((wh, idx) => (
                <div key={idx} className="border-b border-zinc-900 pb-2">
                  ...
                  <div className="mt-1 text-zinc-400">{t(wh.hours)}</div>
                </div>
              ))}
              <div className="pt-1">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-zinc-900 py-6 px-4 sm:px-6 lg:px-8 text-xs text-zinc-400">
