-- ==============================================================================
-- KGH DENTAL CLINIC — COMPLETE SUPABASE DATABASE MIGRATION & DATA SYNC
-- Generated: 2026-09-15T10:53:31.604Z
--
-- Instructions:
-- 1. Open Supabase Dashboard (https://supabase.com/dashboard)
-- 2. Select your KGH project -> click "SQL Editor" on the left navigation menu
-- 3. Click "+ New query"
-- 4. Copy and paste ALL contents of this script into the editor
...
-- ==============================================================================
-- 1. TABLE DEFINITIONS (IF NOT EXISTS) & SCHEMA UPGRADES
-- ==============================================================================
...
-- Ensure all columns exist on departments
...
-- Ensure image_url exists on sub_services
...
-- Ensure doctor metadata columns exist
...
DO $$ BEGIN
    ...
    CREATE POLICY "Admin media insert" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'kgh-media');

    DROP POLICY IF EXISTS "Admin media update" ON storage.objects;
    CREATE POLICY "Admin media update" ON storage.objects FOR UPDATE USING (bucket_id = 'kgh-media');

    DROP POLICY IF EXISTS "Admin media delete" ON storage.objects;
    CREATE POLICY "Admin media delete" ON storage.objects FOR DELETE USING (bucket_id = 'kgh-media');
EXCEPTION WHEN OTHERS THEN
    NULL;
END $$;

-- ==============================================================================
-- 3. DOCTORS DATA (6 DOCTORS)
-- ==============================================================================
...
-- ==============================================================================
-- 6. CLINIC SETTINGS (LEVEL 4 CHANDIWALA MANSION LOCATION & CONFIG)
-- ==============================================================================
...
INSERT INTO public.reviews (
    id, author_name, rating, date, comment_en, comment_bn, treatment_en, treatment_bn, updated_at
) VALUES (
    'rev-1',
    'Rafiqul Islam',
    5,
...
-- ==============================================================================
-- 8. HOMEPAGE WHY CHOOSE US CARDS
-- ==============================================================================
INSERT INTO public.why_choose_cards (
    id, step_number, badge_en, badge_bn, title_en, title_bn, subtitle_en, subtitle_bn,
    bullets, tags, image, accent, protocol_title_en, protocol_title_bn, protocol_subtitle_en,
    protocol_subtitle_bn, protocol_steps, protocol_guarantees, updated_at
) VALUES (
    'specialists',
    '01',
    'Specialist Board',
    ...
    '[{"en":"FCPS & Masters Certified Surgeons","bn":"এফসিপিএস ও স্নাতকোত্তর ডিগ্রিধারী সার্জন"},{"en":"Dedicated Department Heads","bn":"নির্দিষ্ট বিভাগের স্বতন্ত্র প্রধান"},{"en":"Zero Generalist Guesswork","bn":"অনুমাননির্ভর চিকিৎসার সুযোগ নেই"}]'::jsonb,
    '[{"en":"Orthodontics","bn":"অর্থোডন্টিক্স"},{"en":"Oral Surgery","bn":"ওরাল সার্জারি"},{"en":"Endodontics","bn":"এন্ডোডন্টিক্স"},{"en":"Prosthodontics","bn":"প্রস্থোডন্টিক্স"}]'::jsonb,
    ...
    '[{"number":"01","title":{"en":"Primary Specialty Assessment","bn":"প্রাথমিক বিভাগীয় মূল্যায়ন"},"detail":{"en":"Diagnostic imaging and focused examination by a certified department consultant.","bn":"বিভাগীয় বিশেষজ্ঞ কনসালটেন্ট কর্তৃক ডিজিটাল প্রতিচ্ছবি ও গভীর পরীক্ষা।"}},{"number":"02","title":{"en":"Inter-Disciplinary Board Review","bn":"সম্মিলিত মেডিকেল বোর্ড রিভিউ"},"detail":{"en":"Multi-specialist consensus on complex aligner, surgical, or implant therapies.","bn":"জটিল সার্জারি বা অ্যালাইনার চিকিৎসায় যৌথ মেডিকেল বোর্ডের সমন্বিত মতামত।"}},{"number":"03","title":{"en":"Precision Surgical Execution","bn":"নির্ভুল বিশেষজ্ঞ চিকিৎসা সম্পাদন"},"detail":{"en":"Implementation following global clinical guidelines and microscopic accuracy.","bn":"আন্তর্জাতিক মানদণ্ড এবং আধুনিক মাইক্রোস্কোপিক নির্ভুলতায় চিকিৎসা।"}}]'::jsonb,
...
INSERT INTO public.why_choose_cards (
    ...
    '[{"en":"Ergonomic Memory-Foam Dental Chairs","bn":"আরামদায়ক মেমোরি-ফোম চেয়ার"},{"en":"Class-B European Autoclave Sterilization","bn":"ক্লাস-বি অটোক্লেভ স্টেরিলাইজেশন"},{"en":"Soothing Acoustic & Ambient Lighting","bn":"শান্ত ও আরামদায়ক পরিবেশ"}]'::jsonb,
    '[{"en":"Class-B 134°C","bn":"ক্লাস-বি ১৩৪° সে."},{"en":"Zero Cross-Infection","bn":"জীবাণুমুক্ত নিশ্চয়তা"},{"en":"Calm Atmosphere","bn":"শান্ত পরিবেশ"}]'::jsonb,
    ...
    '[{"number":"01","title":{"en":"Class-B Vacuum Decontamination","bn":"ক্লাস-বি ভ্যাকুয়াম জীবাণুমুক্তকরণ"},"detail":{"en":"134°C steam under pressure guarantees 100% viral and bacterial eradication.","bn":"১৩৪° সেলসিয়াস তাপমাত্রায় উচ্চ চাপে প্রতিটি যন্ত্রের শতভাগ জীবাণুমুক্তকরণ।"}},{"number":"02","title":{"en":"Sealed Barrier Pouches","bn":"সিল করা জীবাণুমুক্ত প্যাকেট"},"detail":{"en":"Instruments are opened exclusively in front of each individual patient.","bn":"প্রতিটি রোগীর চোখের সামনেই সিল করা নতুন জীবাণুমুক্ত প্যাকেট খোলা হয়।"}},{"number":"03","title":{"en":"Operatory Surface Disinfection","bn":"চেয়ার ও মেঝের বায়ো-ডিসইনফেকশন"},"detail":{"en":"Medical-grade hospital wipes applied after every single appointment.","bn":"প্রতিটি রোগীর পরপরই সম্পূর্ণ চেয়ার ও যন্ত্রপাতি স্প্রে দ্বারা ডিসইনফেক্ট করা হয়।"}}]'::jsonb,
...
INSERT INTO public.why_choose_cards (
    ...
    '[{"en":"HD Intraoral Digital Camera Screening","bn":"এইচডি ইন্ট্রাওরাল স্ক্রিনিং"},{"en":"Itemized Cost Breakdown — Zero Hidden Bills","bn":"অগ্রিম খরচের স্বচ্ছ বিবরণ"},{"en":"Clear Step-by-Step Clinical Roadmap","bn":"ধাপভিত্তিক স্পষ্ট পরিকল্পনা"}]'::jsonb,
    '[{"en":"Written Estimate","bn":"লিখিত খরচের বিবরণ"},{"en":"HD Live Screen","bn":"লাইভ এইচডি স্ক্রিন"},{"en":"No Hidden Costs","bn":"কোনো গোপন খরচ নেই"}]'::jsonb,
    ...
    '[{"number":"01","title":{"en":"Live Intraoral Camera Display","bn":"লাইভ ইন্ট্রাওরাল ক্যামেরা ডিসপ্লে"},"detail":{"en":"High-definition visuals on the chairside monitor so you see what the doctor sees.","bn":"চেয়ারের সামনে এইচডি মনিটরে সরাসরি দাঁতের প্রকৃত সমস্যা রোগীকে দেখানো।"}},{"number":"02","title":{"en":"Comprehensive Treatment Roadmap","bn":"ধাপভিত্তিক পূর্ণাঙ্গ পরিকল্পনা"},"detail":{"en":"Clear explanation of stages, expected recovery duration, and milestone visits.","bn":"চিকিৎসার প্রয়োজনীয় ধাপ, সময়কাল ও পরবর্তী চেকআপের স্পষ্ট ধারণা।"}},{"number":"03","title":{"en":"Fixed Itemized Cost Estimate","bn":"নির্ধারিত খরচের লিখিত তালিকা"},"detail":{"en":"Transparent billing with zero surprise add-ons or sudden charges.","bn":"চিকিৎসা শুরুর পূর্বেই লিখিত খরচের বিবরণ — কোনো বাড়তি গোপন চার্জ নেই।"}}]'::jsonb,
...
INSERT INTO public.why_choose_cards (
    ...
    '[{"en":"Select Specialist & Preferred Day in < 2 Mins","bn":"ডাক্তার ও সুবিধাজনক দিন পছন্দ"},{"en":"Instant WhatsApp & SMS Confirmation","bn":"তাৎক্ষণিক হোয়াটসঅ্যাপ নিশ্চিতকরণ"},{"en":"Dedicated Clinic Care Coordinator Support","bn":"ডেডিকেটেড কেয়ার কোঅর্ডিনেটর"}]'::jsonb,
    '[{"en":"2-Min Booking","bn":"২ মিনিটে বুকিং"},{"en":"WhatsApp Updates","bn":"হোয়াটসঅ্যাপ আপডেট"},{"en":"Min Waiting","bn":"অপেক্ষাহীন সেবা"}]'::jsonb,
    ...
    '[{"number":"01","title":{"en":"Online Booking in 3 Easy Steps","bn":"৩টি সহজ ধাপে অনলাইন বুকিং"},"detail":{"en":"Choose department, preferred doctor, and available time slot in under 2 minutes.","bn":"বিভাগ, কাঙ্ক্ষিত ডাক্তার ও সুবিধাজনক সময় বেছে নিয়ে দ্রুত সিরিয়াল নিশ্চিতকরণ।"}},{"number":"02","title":{"en":"Instant WhatsApp Confirmation","bn":"তাৎক্ষণিক হোয়াটসঅ্যাপ নোটিফিকেশন"},"detail":{"en":"Receive reference code, appointment time, and direct Google Maps location pin.","bn":"সিরিয়াল রেফারেন্স কোড, সময় ও গুগল ম্যাপ লোকেশন সরাসরি মেসেজে প্রাপ্তি।"}},{"number":"03","title":{"en":"Zero-Wait Queue Management","bn":"যথাসময়ে সিরিয়াল প্রদান"},"detail":{"en":"Our front desk prepares all sterile setup in advance to minimize waiting time.","bn":"রোগীর পৌঁছানোর পূর্বেই চেম্বার প্রস্তুতি সম্পন্ন করে অপেক্ষার সময় কমিয়ে আনা।"}}]'::jsonb,
...
-- ==============================================================================
-- 9. HOMEPAGE CLINICAL CREED
-- ==============================================================================

INSERT INTO public.clinical_creed (
    id, tag_en, tag_bn, quote_en, quote_bn, sub_quote_en, sub_quote_bn,
    authority_en, authority_bn, designation_en, designation_bn, stats, updated_at
) VALUES (
    1,
    'OUR CLINICAL CREED',
    ...
    '[{"value":{"en":"100%","bn":"১০০%"},"label":{"en":"Sterilization Standard","bn":"জীবাণুমুক্তকরণ মানদণ্ড"}},{"value":{"en":"15+","bn":"১৫+"},"label":{"en":"Years Combined Board Mastery","bn":"সম্মিলিত বোর্ড অভিজ্ঞতা"}},{"value":{"en":"Zero","bn":"জিরো"},"label":{"en":"Unscheduled Waiting Delay","bn":"অতিরিক্ত অপেক্ষাহীন সেবা"}}]'::jsonb,
    NOW()
) ON CONFLICT (id) DO UPDATE SET
...
-- ==============================================================================
-- 10. VERIFICATION SUMMARY QUERY
-- ==============================================================================
SELECT 'Departments' AS entity, COUNT(*) AS count FROM public.departments
UNION ALL
SELECT 'Sub-Services (with images)' AS entity, COUNT(*) AS count FROM public.sub_services
UNION ALL
SELECT 'Doctors' AS entity, COUNT(*) AS count FROM public.doctors
UNION ALL
SELECT 'Clinic Settings' AS entity, COUNT(*) AS count FROM public.clinic_settings
UNION ALL
SELECT 'Reviews' AS entity, COUNT(*) AS count FROM public.reviews
UNION ALL
SELECT 'Why Choose Us Cards' AS entity, COUNT(*) AS count FROM public.why_choose_cards
UNION ALL
SELECT 'Clinical Creed' AS entity, COUNT(*) AS count FROM public.clinical_creed;
